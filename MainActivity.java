...
public class MainActivity extends AppCompatActivity {
    ...
    RequestQueue queue; //a queue in the web server (waiting...), else dequeue (user press 'back' button)
    ...
    private boolean isConnected() {
        ...
        return activeNetwork != null && activeNetwork.isConnectedOrConnecting(); //About "network connect or not? :\"
